...
function ContactForm() {
	...
	const handleCheckCopun = () => {
		if (cupon === "CUAN" && packages === "FL Project") {
			setIsCuponTrue(true);
			setShow(true);
		} else if (cupon === "PIPS" && packages === "FL Pro") {
			setIsCuponTrue(true);
			setShow(true);
			...
			<div>
				<div className="form-success">
					...
					<p className="form-success-p">
						Kontak Admin Untuk Melakukan Konfirmasi
					</p>
					<div className="form-success-button-bg">
						<Button
							className="form-success-button"
							href="https://api.whatsapp.com/send/?phone=6282147054454&text&type=phone_number&app_absent=0"
						>
							<IoLogoWhatsapp /> Admin
						</Button>
					</div>
				</div>
			...
			<Container fluid="lg">
				<ToastContainer position="top-center">
					...
					>
						...
						<Toast.Body>congrats... Discount added</Toast.Body>
					</Toast>
				</ToastContainer>
										...
										<Accordion.Header>
											<div className="detail-order-total-header">
												...
												<div>
													{(() => {
														if (packages === "FL Project") {
															return <p>Rp 3.500.000</p>;
														} else if (packages === "FL Pro") {
															return <p>Rp 249.000</p>;
														} else if (packages === "1 on 1 Course") {
															return <p>Rp 7.000.000</p>;
														} else {
															return <p>-</p>;
														}
													})()}
													...
													if (packages === "FL Project") {
														return (
															<div>
																...
																<Form.Group className="mb-3">
																	<Form.Label className="code-cupon-title">
																		Code Cupon
																	</Form.Label>
																	<Form.Control
																		type="text"
																...
																<div className="mb-3">
																	<button onClick={handleCheckCopun}>
																		Check Cupon
																	</button>
																</div>
																<div>
														...
														return (
															<div>
																...
																<div className="mb-3 buttonCuppon">
																	<button onClick={handleCheckCopun}>
																		Check Cupon
																	</button>
																</div>
